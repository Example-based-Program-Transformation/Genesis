...
This differs from fixbench_create_asts.py by not creating the ASTs. It just reads the benchmark data and constructs the sql files.
...
path_to_ptbench = "/home/root/Workspace/PTBench-Data/FinalData-Single"
...
# rm /tmp/*round*
#
# then run the following, but changing "503 362 483" to the length of the training examples, and the split for the validation
# MAVEN_OPTS503 362 483 Xmx40g" mvn exec:java -Dexec.mainClass="genesis.learning.Main" -Dexec.args="1 /home/root/Workspace/github/data 503 362 483 36" &> training.log
