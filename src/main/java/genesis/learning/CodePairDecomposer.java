...
public class CodePairDecomposer {
	...
	public ArrayList<DecomposedCodePair> decompose(int debug_i) {
		...
		do {
//			System.out.println("decompose: start of one iteration. of i=" + debug_i);
			t1 = diff.getT1();
			t2 = diff.getT2();
...
//			System.out.println("decompose: reached here. pass=" + pass + " . of i=" + debug_i);
//			System.out.println("decompose: t1 = " + t1 + " t2=" + t2 + "  \n\n\tclazz, t1=" + t1.nodeSig().getClassSig()  + " t2=" + t2.nodeSig().getClassSig() + "  . of i=" + debug_i);
			if (pass && validate(before, after, t1, t2)) {
//				System.out.println("decompose: validation succeeded. of i=" + debug_i);
				ret.add(new DecomposedCodePair(insides, t1, t2));
			}
			insides.add(t1.nodeSig());
			
//			System.out.println("decompose: end of one iteration. of i=" + debug_i);
		}
		while (diff.narrowDown(false, debug_i));
