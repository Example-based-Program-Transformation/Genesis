...
public class TreeDiffer {
	...
	public boolean narrowDown(boolean tolerentDiff, int debug_i) {
//		System.out.println("\ttree differ. i=" + debug_i);
		boolean ret = narrowDown(tolerentDiff);
//		System.out.println("\ttree differ end. i=" + debug_i);
		return ret;
	}
